...
/*LINKER TIL CHILD THEME*/
/*opret en funktion kaldet 'add_styles' som bruger child-themets styling*/
function add_styles(){
    /*difiner en variabel kaldet '$parent_style' med værdien 'TwentySeventeen-style'*/
...
wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.googleapis.com/css?family=Allerta+Stencil', false ); 
}
/*udfør indhold og funktion*/
add_action( 'wp_enqueue_scripts', 'wpb_add_google_fonts' );
/*LINKER TIL CHILD THEME END*/
/**
